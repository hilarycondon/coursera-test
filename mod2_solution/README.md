...
# [](#introduction-to-css3--assignment)Introduction to CSS3 Assignment

Create a simple, responsive site comprised of 3 sections. The text contained within the sections, individual colors,
and label names does not have to match those in the examples provided. The site should be accessible through Github. 

The assignment can be viewed [here](https://hilarycondon.github.io/jhu-coursera-dev/mod2_solution/).
